...
export type BabbageGoStylePreset = 'auroraPulse' | 'emberLagoon' | 'midnightHalo'
...
const STYLE_TOKEN_PRESETS: Record<BabbageGoStylePreset, DesignTokens> = {
  ...
  emberLagoon: {
    overlayColor: 'linear-gradient(130deg, rgba(35,6,0,0.85), rgba(67,4,21,0.92))',
    ...
    cardRadius: '22px',
    fontFamily: '"Sora", "Inter", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
  ...
  midnightHalo: {
    ...
    cardRadius: '20px',
    fontFamily: '"General Sans", "Inter", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
    textPrimary: '#0f1528',
