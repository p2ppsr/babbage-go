...
function overlayRoot (mount?: HTMLElement | null) {
  ...
  ((mount != null) || document.body).appendChild(root)
...
export default class BabbageGo implements WalletInterface {
  ...
  async getPublicKey (
    ...
    return await this.executeWithWalletHandling(async () => await this.base.getPublicKey(a, o))
  }
  ...
  async revealCounterpartyKeyLinkage (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.revealCounterpartyKeyLinkage(a, o)
    )
  }
  ...
  async revealSpecificKeyLinkage (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.revealSpecificKeyLinkage(a, o)
    )
  }
  ...
  async encrypt (
    ...
    return await this.executeWithWalletHandling(async () => await this.base.encrypt(a, o))
  }
  ...
  async decrypt (
    ...
    return await this.executeWithWalletHandling(async () => await this.base.decrypt(a, o))
  }

  async createHmac (a: CreateHmacArgs, o?: Origin): Promise<CreateHmacResult> {
    return await this.executeWithWalletHandling(async () => await this.base.createHmac(a, o))
  }

  async verifyHmac (a: VerifyHmacArgs, o?: Origin): Promise<VerifyHmacResult> {
    return await this.executeWithWalletHandling(async () => await this.base.verifyHmac(a, o))
  }
  ...
  async createSignature (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.createSignature(a, o)
    )
  }
  ...
  async verifySignature (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.verifySignature(a, o)
    )
  }

  async signAction (a: SignActionArgs, o?: Origin): Promise<SignActionResult> {
    return await this.executeWithWalletHandling(async () => await this.base.signAction(a, o))
  }
  ...
  async listCertificates (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.listCertificates(a, o)
    )
  }
  ...
  async acquireCertificate (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.acquireCertificate(a, o)
    )
  }
  ...
  async proveCertificate (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.proveCertificate(a, o)
    )
  }
  ...
  async relinquishCertificate (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.relinquishCertificate(a, o)
    )
  }
  ...
  async internalizeAction (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.internalizeAction(a, o)
    )
  }
  ...
  async relinquishOutput (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.relinquishOutput(a, o)
    )
  }
  ...
  async discoverByAttributes (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.discoverByAttributes(a, o)
    )
  }
  ...
  async discoverByIdentityKey (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.discoverByIdentityKey(a, o)
    )
  }
  ...
  async getHeaderForHeight (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.getHeaderForHeight(a, o)
    )
  }
  ...
  async getNetwork (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.getNetwork(a as any, o)
    )
  }
  ...
  async abortAction (
    ...
    return await this.executeWithWalletHandling(async () =>
      await this.base.abortAction(a as any, o)
    )
  }
}
