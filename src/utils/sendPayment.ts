...
export async function sendPayment (
  ...
  if (recipients.developer != null) {
    ...
    if (developerPublicKey == null || developerPublicKey.trim() === '') { throw new Error('Failed to derive developer’s public key') }
  ...
  if (basePublicKey == null || basePublicKey.trim() === '') { throw new Error('Failed to derive base’s public key') }
